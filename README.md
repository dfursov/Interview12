1. Создайте fork репозитория https://github.com/MyITschool/Interview12 в своём аккаунте на ginhub.com
...
3. Создайте pull request в ветку main репозитория https://github.com/MyITschool/Interview12. После того, как видео запись выполнения задания загрузится в облачное хранилище, укажите ссылку на видеозапись в качестве комментария к pull requst’у.
